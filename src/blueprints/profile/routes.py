...
'''
    ...
    if error:
        profile_data = {
            ...
            "email": email,
            "prefs": {
                "favorite_bus_types": [favorite_types] if favorite_type else [],
                "favorite_routes": [favorite_routes] if favorite_route else [],
                "favorite_stops": [favorite_stops] if favorite_route else [],
                "theme": theme,
                "alerts": alerts
            }
        }
